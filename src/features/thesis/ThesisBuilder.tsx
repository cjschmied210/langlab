...
export const ThesisBuilder: React.FC<ThesisBuilderProps> = ({ authorName, availableVerbs, onClose, onSave }) => {
    ...
    return (
        <div
            className="fixed bottom-0 left-0 right-0 bg-surface border-t border-primary/20 shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.1)] z-40 flex flex-col animate-in slide-in-from-bottom-10 duration-300"
            style={{ height: '400px' }}
        >
            {/* Header / Close Bar */}
